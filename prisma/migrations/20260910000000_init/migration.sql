...
-- CreateIndex
CREATE INDEX "CompanionProfile_verificationStatus_isFeatured_averageRatin_idx" ON "CompanionProfile"("verificationStatus", "isFeatured", "averageRating");

-- CreateIndex
CREATE INDEX "CompanionProfile_verificationStatus_cityId_hourlyPrice_idx" ON "CompanionProfile"("verificationStatus", "cityId", "hourlyPrice");
...
-- CreateIndex
CREATE INDEX "Booking_companionId_status_createdAt_idx" ON "Booking"("companionId", "status", "createdAt");
...
-- CreateIndex
CREATE INDEX "Conversation_companionUserId_lastMessageAt_idx" ON "Conversation"("companionUserId", "lastMessageAt");
